...
public class ManageStudentJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageStudentJPanel(JPanel userProcessContainer, StudentDirectory studentDir, CourseCatalog coruseCatalog) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(searchBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 190, -1, -1));
        ...
        hideInOutPanel.add(updateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, -1, -1));
        ...
        hideInOutPanel.add(saveBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 160, -1, -1));

        jButton1.setText("Status Update");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        hideInOutPanel.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 160, -1, -1));
        ...
        add(createStudentBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 40, -1, -1));
        ...
        add(idTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 150, 196, -1));

        jLabel1.setText("or");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 80, -1, -1));

        jLabel2.setText("Edit a Student Profile");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 130, 22));

        jLabel3.setText("Student ID");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, 60, 20));
    ...
    private void createStudentBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createStudentBtnActionPerformed
        // TODO add your handling code here:
        CreateStudentCredentialsJPanel createUserCredential = new CreateStudentCredentialsJPanel(userProcessContainer, studentDir);
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        if (id == null) {
            ...
            if (student == null) {
                ...
                this.pwdTextArea.setText(student.getPassword());
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        if (student_id.isBlank() || pwd.isBlank()) {
            ...
            this.student.setUserId(student_id);
            this.student.setPassword(pwd);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        CourseInformationJPanel Course = new CourseInformationJPanel(userProcessContainer, student, courseCatalog);
        userProcessContainer.add("Course",Course);
        ((CardLayout)userProcessContainer.getLayout()).next(userProcessContainer);
